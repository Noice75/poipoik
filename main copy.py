...
def update_date_monitoring_config():
    ...
    """
    global target_end_date, telegram_enabled, telegram_bot_token, telegram_chat_id
    ...
    if telegram_bot_token and telegram_chat_id:
        ...
        print("Telegram alerts are disabled. Set TELEGRAM_BOT_TOKEN and TELEGRAM_CHAT_ID to enable.")
    ...
    while True:
        try:
            ...
            if telegram_bot_token and telegram_chat_id:
                ...
                print("Telegram alerts are disabled. Set TELEGRAM_BOT_TOKEN and TELEGRAM_CHAT_ID environment variables to enable.")
